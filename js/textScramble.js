...
// Initialize the effect when document is ready
document.addEventListener('DOMContentLoaded', function() {
  const nameElement = document.getElementById('home');
  ...
  function scramble() {
    ...
    // Generate a random scrambled version
    let scrambledText = '';
    for (let i = 0; i < originalText.length; i++) {
      scrambledText += scrambler.randomChar();
    }
